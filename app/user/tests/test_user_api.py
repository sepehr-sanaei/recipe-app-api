...
class PublicUserApiTest(TestCase):
    ...
    def test_create_user_success(self):
        """Test creatin a user is successful."""
        payload = {
    ...
    def test_user_with_email_exists_error(self):
        """Test that creating a user with un-unique email raises error"""
        payload = {
            'email': 'test@example.com',
            'password': 'testpass123',
            'name': 'Test Name',
    ...
    def test_create_token_bad_credentials(self):
        """Test creating a token for a user with invalid credentials."""
    ...
    def test_create_token_blank_password(self):
        """Test creating a token with a blank password."""
        payload = {
            'email': 'test@example.com',
            'password': '',
        }
    ...
    def test_retrieve_user_auauthorized(self):
        """Test athentication is required for users."""
...
class PrivateUserTests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test Post method to me is not allowed."""
        res = self.client.post(ME_URL, {})

        self.assertEqual(res.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)

    def test_update_user_profile(self):
        """Test updating user profile with authenticated user."""
        payload = {
            'name': 'Updated Name',
